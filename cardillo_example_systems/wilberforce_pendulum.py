...
def gen_wilberforce_pendulum(nturns=20, nelements_per_turn=40):
    # gravity
    gravity = 9.81
    ...
    #######################
    nelements = int(nelements_per_turn * nturns)

    # parameters from Harsch2021
    rho = 7850  # [kg / m^3]
    G = 81.5e9
    E = 206.0e9
    ...
    return {"system": system, "rod": rod, "bob": bob}
