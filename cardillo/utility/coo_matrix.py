...
class CooMatrix:
    ...
    def asformat(self, format, copy=False, cached=False):
        ...
        try:
            return convert_method(copy=copy, cached=cached)
        except TypeError:
