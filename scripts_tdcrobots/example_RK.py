...
# ScipyDAE solver
#################
solver = ScipyDAE(system, 7.0, dt, rtol=1e-3, atol=1e-6)
...
####################
t1 = perf_counter()
t, y =runge_kutta_4(dydt, y0, 0, 7, dt)
# t, y =runge_kutta_3_8(dydt, y0, 0, 7, dt)

# sol_ivp = solve_ivp(dydt, (0, 7), y0, method='RK45', t_eval=np.arange(0, 7, dt))
